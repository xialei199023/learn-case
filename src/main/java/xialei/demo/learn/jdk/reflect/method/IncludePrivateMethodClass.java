 ...
 *
 * Creation Date: 2016年3月22日 上午9:55:52
 * $Id$
 */
 ...
 * @date 2016年3月22日 上午9:55:52 
 * @since JDK 1.7
 */
public class IncludePrivateMethodClass {
	
	private String privateMethodParamInt(int param) {
		return "privateMethodParamInt";
	}
}
